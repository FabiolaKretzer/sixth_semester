...
public:
    ...
    Smart_Data<MY_Temperature_Transducer> * data,
    const Smart_Data<MY_Temperature_Transducer>::Value & command) {
...
int main()
{
    ...
    My_Temperature t(0, 15000000, My_Temperature::PRIVATE); /* TODO: Complete the constructor parameters */

    while(true) {
        Alarm::delay(5000000); // 5s
        cout << "Temperature = " <<  t.operator Value()/* TODO: use operator Value() */
             << " at " << t.location() /* TODO: use location() method */
             << ", " << t.time()  /* TODO: use time() method */ << endl;
    }
